		...
		OnStartedLeading: func(leCtx context.Context) {
			...
			if runServerWithSnapshotter {
				...
				if b.config.SecondarySnapstoreConfig.BackupSyncEnabled {
					...
					backupssr, err := snapshotter.NewSnapshotter(b.logger, b.config.SnapshotterConfig, ss, b.config.EtcdConnectionConfig, b.config.CompressionConfig, b.config.Keyring, b.config.HealthConfig, b.config.SecondarySnapstoreConfig.StoreConfig)
					if err != nil {
				...
				ssr, err = snapshotter.NewSnapshotter(b.logger, b.config.SnapshotterConfig, ss, b.config.EtcdConnectionConfig, b.config.CompressionConfig, b.config.Keyring, b.config.HealthConfig, b.config.SnapstoreConfig)
				if err != nil {
